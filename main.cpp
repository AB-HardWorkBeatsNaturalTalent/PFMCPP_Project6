...
int main()
{
    ...
    {
        std::cout << "smaller is null. f.compare() returned nullptr. ensure its arguments are not null and that their values are not equal. the function returns nullptr if the values are equal" << std::endl;
    }
